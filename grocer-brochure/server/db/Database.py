...
c.execute("""INSERT INTO merchants (id, country, merchant_name, admin_id, image1_path) VALUES(4001, "USA", "Safeway",70766, "../Images/safeway-logo.png")""")
...
c.execute("""INSERT INTO products (id, name, merchant_id, price, description, image ) VALUES (1, "Cheese", 4001, 2.99, "tastes good", "../Images/safeway-logo.png") """)
c.execute("""INSERT INTO products (id, name, merchant_id, price, description, image ) VALUES (2, "Coke", 4001, 3.99, "tastes ok", "../Images/costcoLogo.png") """)
c.execute("""INSERT INTO products (id, name, merchant_id, price, description, image ) VALUES (3, "Buns", 4001, 4.99, "tastes bad", "../Images/Walgreens-Logo.png") """)
...
c.execute("""INSERT INTO products (id, name, merchant_id, price, description) (67352, "Cats", 4002, 4.99, "tastes Catty") """)
c.execute("""INSERT INTO products (id, name, merchant_id, price, description)  (5323, "Motivation to work on senior project", 4002, 4.99, "Almost all gone") """)
c.execute("""INSERT INTO products (id, name, merchant_id, price, description)  (4251, "Sandwhich", 4002, 4.75, "Subway bad") """)
